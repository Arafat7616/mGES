...
class VisaProcessController extends Controller
{
    public function stampingRequested()
    {
        ...
        return view('MalaysiaEmbassy.VisaProcess.stamping_requested', compact('offeredCandidates'));
    }
    public function stampingApproved()
    {
        ...
        return view('MalaysiaEmbassy.VisaProcess.stamping_approved', compact('offeredCandidates'));
    }
    public function stampingRejected()
    {
        ...
        return view('MalaysiaEmbassy.VisaProcess.stamping_rejected', compact('offeredCandidates'));
    }

    public function requestedCandidateProfile($offered_candidate_id){
        $offeredCandidate = OfferedCandidate::findOrFail($offered_candidate_id);
        return view('MalaysiaEmbassy.VisaProcess.requested-candidate-profile', compact('offeredCandidate'));
    }

    public function approvedCandidateProfile($offered_candidate_id){
        $offeredCandidate = OfferedCandidate::findOrFail($offered_candidate_id);
        return view('MalaysiaEmbassy.VisaProcess.approved-candidate-profile', compact('offeredCandidate'));
    }

    public function rejectedCandidateProfile($offered_candidate_id){
        $offeredCandidate = OfferedCandidate::findOrFail($offered_candidate_id);
        return view('MalaysiaEmbassy.VisaProcess.rejected-candidate-profile', compact('offeredCandidate'));
    }
}
