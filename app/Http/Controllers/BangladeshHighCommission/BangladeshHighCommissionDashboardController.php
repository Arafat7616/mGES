...
class BangladeshHighCommissionDashboardController extends Controller
{
    public function dashboard(){
        $user = User::find(Auth::user()->id);
        if ($user->active_status == "New" || $user->active_status == 'Pending' || $user->active_status == 'Rejected') {
            return view('BangladeshHighCommission.pending-profile', compact('user'));
        }
        return view('BangladeshHighCommission.welcome');
    }

    public function companyPrfileView(){
        $user = User::find(Auth::user()->id);
        return view('BangladeshHighCommission.profile', compact('user'));
    }
    ...
    {
        $user = Auth::user();
        return view('BangladeshHighCommission.profile-edit', compact('user'));
    }
