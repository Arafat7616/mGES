...
class OneStopService_ChildDashboardController extends Controller
{
    public function dashboard(){
        ...
        return view('OneStopService_Child.welcome');
    }
    public function companyPrfileView(){

        $user = User::find(Auth::user()->id);
        return view('OneStopService_Child.profile', compact('user'));
    }

    public function editProfile()
    {
        $user = Auth::user();
        return view('OneStopService_Child.profile-edit', compact('user'));
    }
