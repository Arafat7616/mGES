...
Route::group(['prefix' => 'bangladesh-embassy/', 'namespace' => 'BangladeshEmbassy', 'as' => 'BangladeshEmbassy.', 'middleware' => ['auth', 'bangladesh-embassy']], function () {
    ...
    Route::get('/edit-profile', 'BangladeshEmbassyDashboardController@editProfile')->name('editProfile');
    Route::post('/update-profile', 'BangladeshEmbassyDashboardController@updateProfile')->name('updateProfile');
