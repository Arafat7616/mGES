<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            ...
            <a href="{{ route('OneStopService_Child.dashboard') }}" class="logo"><img src="{{ asset('assets/images/mges.png') }}" height="40"></a>
            <a href="{{ route('OneStopService_Child.dashboard') }}" class="logo-sm"><img src="{{asset('assets/images/mges.png')}}" height="36"></a>
