<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="{{ route('OneStopService_Child.dashboard') }}" class="logo"><img src="{{ asset('assets/images/mges.png') }}" height="72px" width="100%" style="background: #03a9f4;"></a>
            <a href="{{ route('OneStopService_Child.dashboard') }}" class="logo-sm"><img src="{{ asset('assets/images/mges-sm.png') }}" height="72px" width="100%" style="background: #03a9f4;"></a>
        </div>
    </div>
                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    ...
                    <li class="nav-item dropdown user-menu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <li class="user-footer">
                                <div class="left">
                                    <a href="{{ route('OneStopService_Child.companyPrfileView') }}">
                    ...
                    {{-- <li class="dropdown" >
                        ...
                        <ul class="dropdown-menu" >
                            ...
                            <li><a href="{{ route('OneStopService_Child.companyPrfileView') }}"> Profile</a>
                            </li>
                            @endif
