...
@section('title', 'Interview Candidates')
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header-title">
                    <h4 class="pull-left page-title">Interview Candidates</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="#">Excelanto</a></li>
                        <li><a href="#">Candidates</a></li>
                        <li class="active">Interview Candidates</li>
                    </ol>
                                ...
                                @foreach ($offeredCandidates as $candidate)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif ($candidate->result_status == "Under-Interview-Proces")
                                                <span class="badge badge-info">Under-Interview-Proces</span>
                                            @else
