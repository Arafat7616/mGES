                ...
                <div class="col-sm-12">
                    <div class="page-header-title">
                        ...
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">mGES</a></li>
                            <li><a href="#">Call Center Requests</a></li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">New Call Center Requests</h3>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-success" onclick="approve(this)"
                                                    value="{{ route('BangladeshAdmin.callCenter.approveNow', $user->id) }}">
                                                    <i class="mdi mdi-check"></i> </button>

                                            </td>
                                            <td>
                                                <button class="btn btn-danger" onclick="reject(this)"
                                                    value="{{ route('BangladeshAdmin.callCenter.rejectNow', $user->id) }}">
