...
@section('title', 'Bangladesh High Commission Request')
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">New Bangladesh High Commission  Requests</h3>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-success" onclick="approve(this)"
                                                    value="{{ route('BangladeshAdmin.bangladeshHighCommission.approveNow', $user->id) }}">
                                                    <i class="mdi mdi-check"></i> </button>

                                            </td>
                                            <td>
                                                <button class="btn btn-danger" onclick="reject(this)"
                                                    value="{{ route('BangladeshAdmin.bangladeshHighCommission.rejectNow', $user->id) }}">
