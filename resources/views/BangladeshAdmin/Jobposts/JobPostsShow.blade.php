            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Show Job Posts</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">Excelanto</a></li>
                            <li><a href="#">Job Posts</a></li>
                            <li class="active">Show Posted Job</li>
                        </ol>
                    ...
                    <div class="panel panel-primary panel-outline">
                        <div class="panel-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                              ...
                              <li class="list-group-item">
                                <b>Appointment Time</b> <a class="float-right">{{ date('H:i:s', strtotime($job_post->appointment_time))  }}</a>
                              </li>
                              <li class="list-group-item">
