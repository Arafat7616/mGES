                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form role="form" action="{{ route('TrainingAgency.candidate.add_training_report', $offeredCandidate->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-5 col-lg-5 col-xl-5">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <label for="address">Post-Training Status</label>
                                                <select class="form-control custom-select" name="post_training_status" required="">
                                                    <option selected="" disabled="" value="">Select candidate status</option>
                                                    <option value="Pass">Training (Pass)</option>
                                                    <option value="Fail">Training (Fail)</option>
                                                  </select>
                                            </div>
                                            <div class="form-group">
