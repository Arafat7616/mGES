                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-Zlink" href="#results" data-toggle="tab">Results</a></li>
                                <li class="nav-item"><a class="nav-Zlink" href="#travel" data-toggle="tab">Travel</a></li>
                            </ul>
                        </div><!-- /.card-header -->
                                ...
                                <div class="tab-pane" id="travel">
                                        <div class="card-body">
                                          <dl class="row">
                                            ...
                                            <dd class="col-sm-8">{{ $offeredCandidate->date_of_journey }}</dd><br>
                                            <dt class="col-sm-4">Flight Number</dt>
                                            <dd class="col-sm-8">{{ $offeredCandidate->filght_number }}</dd><br>
                                            <dt class="col-sm-4">Ticket Cost</dt>
                                            <dd class="col-sm-8">{{ $offeredCandidate->ticket_cost }}</dd><br>
                                            <dt class="col-sm-4">Flight Ticket</dt>
                                            <dd class="col-sm-8">
                                                @if($offeredCandidate->ticket_pdf)
                                                    <a href="{{ asset($offeredCandidate->ticket_pdf) }}" target="_blank">
                                                        <strong><i class="fa fa-file mr-1"></i> </strong>
                                                    </a>
                                                    <div class="mailbox-attachment-info">
                                                        <a href="{{ asset($offeredCandidate->ticket_pdf) }}" download class="btn btn-default btn-xs float-right"><i class="fa fa-cloud-download"></i></a>
                                                    </div>
                                                @else
                                                    <a title="Sorry there is no document">
                                                        <strong><i class="fa fa-file mr-1"></i> </strong>
