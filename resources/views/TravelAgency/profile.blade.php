                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <form role="form" method="POST" enctype="multipart/form-data"
                                    action="{{ route('TravelAgency.companyPrfileSubmit') }}">
                                    @csrf
                                    <div class="row">
                                        <!-- Basic example -->
                        ...
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body">
                                <div class="text-center">
                                    ...
                                    <h1 class="profile-name">{{ $user->name }} <a class="btn btn-success" href="{{ route('TravelAgency.editProfile') }}"><i class="fa fa-edit"></i> Edit Profile </a></h1>
                                </div>
                                <div class="row">
                                    <ul class="list-group">
