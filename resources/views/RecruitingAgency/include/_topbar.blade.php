<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="{{ route('RecruitingAgency.dashboard') }}" class="logo"><img src="{{ asset('assets/images/mges.png') }}" height="28"></a>
                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    ...
                    <li class="nav-item dropdown user-menu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                          ...
                          <li class="user-footer">
                            <div class="left">
                                <a href="{{ route('RecruitingAgency.companyPrfileView') }}">
                    ...
                    {{-- <li class="dropdown" >
                        ...
                        <ul class="dropdown-menu" >
                            ...
                            <li><a href="{{ route('RecruitingAgency.companyPrfileView') }}"> Profile</a>
                            </li>
                            @endif
