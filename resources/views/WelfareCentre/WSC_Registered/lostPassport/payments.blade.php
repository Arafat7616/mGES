...
@section('title', 'Lost Passport  Payment')
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Lost Passport  payment</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">Welfare Centre</a></li>
                            <li><a href="#"> WSC registered users
                                </a></li>
                            <li class="active">Lost Passport  payment</li>
                        </ol>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Lost Passport  payments</h3>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($lostPassportServices as $lostPassportService)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info btn-xs" href="{{ route('WelfareCentre.lostPassport.receipt', $lostPassportService->id) }}"> <i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
