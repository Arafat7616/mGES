...
@section('title', 'Lost Passport  requests')
                ...
                <div class="col-sm-12">
                    <div class="page-header-title">
                        ...
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="active">Lost Passport  Request</li>
                        </ol>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Lost Passport  Requests</h3>
                        </div>
                                    ...
                                    @foreach ($lostPassportServices as $lostPassportService)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-primary btn-xs" href="{{ route('WelfareCentre.lostPassport.upload', $lostPassportService->id) }}"> <i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
