...
@section('title', 'New Passport requests')
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">New Passport Request</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">Welfare Centre</a></li>
                            <li><a href="#"> WSC registered users
                                </a></li>
                            <li class="active">New Passport Request</li>
                        </ol>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">New Passport Requests</h3>
                        </div>
                                    ...
                                    @foreach ($newPassportServices as $newPassportService)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-primary btn-xs" href="{{ route('WelfareCentre.newPassport.upload', $newPassportService->id) }}"> <i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
