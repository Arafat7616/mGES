            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Change of visa status</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">Welfare Centre</a></li>
                            <li><a href="#"> WSC registered users
                                </a></li>
                            <li class="active">Change of visa status</li>
                        </ol>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Change of visa status</h3>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                href="{{ route('WelfareCentre.showCandidateProfile', $changeVisaService->candidate->offered_candidate->id) }}"><i
                                                    class="fa fa-eye"></i></a>
                                                <a class="btn btn-primary btn-xs" href="{{ route('WelfareCentre.changeOfVisa.status', $changeVisaService->id) }}"> <i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
