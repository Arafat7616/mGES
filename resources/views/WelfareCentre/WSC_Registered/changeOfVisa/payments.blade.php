...
@section('title', 'Change of visa Payment')
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Change of visa payment</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">Welfare Centre</a></li>
                            <li><a href="#"> WSC registered users
                                </a></li>
                            <li class="active">Change of visa payment</li>
                        </ol>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Change of visa payments</h3>
                        </div>
                                            ...
                                            <td>
                                                ...
                                                @elseif($changeVisaService->service_status == "Not Completed")
                                                    <button type="button" class="btn btn-success btn-xs">Not
                                                        Completed</button>
                                                @else
                                                    <button type="button" class="btn btn-success btn-xs">{{ $changeVisaService->service_status }}</button>
                                                @endif
                                            </td>
                                            <td>
                                                <a class="btn btn-primary btn-xs" href="{{ route('WelfareCentre.changeOfVisa.receipt', $changeVisaService->id) }}"><i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
