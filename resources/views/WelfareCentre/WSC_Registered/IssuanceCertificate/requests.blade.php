            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Issuance certificate requests</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">Welfare Centre</a></li>
                            <li><a href="#"> WSC registered users
                                </a></li>
                            <li class="active">Issuance certificate requests</li>
                        </ol>
                                ...
                                <tbody>
                                    @foreach ($issuanceCertificates as $issuanceCertificate)
                                        <tr>
                                            ...
                                            <td>{{ $issuanceCertificate->service_type }}</td>
                                            <td>{{ $issuanceCertificate->created_at }}</td>
                                            <td>
                                                @if ($issuanceCertificate->service_status == 'Open')
