            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Legalisation Regular by penalty</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">Welfare Centre</a></li>
                            <li><a href="#"> WSC registered users
                                </a></li>
                            <li class="active">Legalisation Regular by penalty</li>
                        </ol>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Legalisation Regular by penalty</h3>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($paymentServices as $paymentService)
                                        <tr>
                                            ...
                                            <td>{{ $paymentService->service_type }}</td>
                                            ...
                                            <td>
                                                ...
                                                href="{{ route('WelfareCentre.showCandidateProfile', $paymentService->candidate->offered_candidate->id) }}"><i
                                                    class="fa fa-eye"></i></a>
                                                <a class="btn btn-primary btn-xs" href="{{ route('WelfareCentre.legalByRegular.status', $paymentService->id) }}"> <i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
