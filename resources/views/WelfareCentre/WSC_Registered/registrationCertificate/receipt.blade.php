                            ...
                            <div class="row">
                                <div class="col-12 table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Certificate Registration</td>
                                                <td>1</td>
                                                <td>$64.50</td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="col-12">
                                    ...
                                    @if ($registrationCertificate->service_status == 'On Process')
                                        <button style="margin-right: 5px;" class="btn btn-success float-right"
                                            ...
                                            value="{{ route('WelfareCentre.registrationCertificate.statusUpdete', $registrationCertificate->id) }}">
                                            <i class="fa fa-credit-card-alt"></i> Submit Payment</button>
                                    @elseif ($registrationCertificate->service_status == 'Paid')
