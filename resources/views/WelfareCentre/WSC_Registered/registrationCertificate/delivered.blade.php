...
@section('title', 'Certificate registration report delivery')
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Certificate registration report delivery</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">Welfare Centre</a></li>
                            <li><a href="#"> WSC registered users
                                </a></li>
                            <li class="active">Certificate registration report delivery</li>
                        </ol>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Certificate registration report delivery status</h3>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($registrationCertificates as $registrationCertificate)
                                        <tr>
                                            ...
                                            <td>{{ $registrationCertificate->delivery_to }}</td>
                                            <td>{{ $registrationCertificate->created_at }}</td>
                                            <td>
                                                <button type="button" class="btn btn-info btn-xs">{{ $registrationCertificate->service_status }}</button>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @if($registrationCertificate->document)
                                                    <a class="btn btn-info btn-xs" href="{{ asset($registrationCertificate->document) }}" target="_blank"><i class="fa fa-eye"></i></a>
                                                @else
