                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Certificate Registration requests</h3>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($registrationCertificates as $registrationCertificate)
                                        <tr>
                                            ...
                                            <td>{{ $registrationCertificate->service_type }}</td>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-primary btn-xs" href="{{ route('WelfareCentre.registrationCertificate.upload', $registrationCertificate->id) }}"> <i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
