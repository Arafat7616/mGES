                ...
                <div class="col-sm-12">
                    <div class="page-header-title">
                        ...
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="active">Certificate Attestation</li>
                        </ol>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Certificate Attestation status</h3>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($attestationCertificates as $attestationCertificate)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info btn-xs" href="{{ route('WelfareCentre.attestationCertificate.receipt', $attestationCertificate->id) }}"> <i class="fa fa-eye"></i></a>
                                                <a class="btn btn-primary btn-xs" href="{{ route('WelfareCentre.attestationCertificate.status', $attestationCertificate->id) }}"> <i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
