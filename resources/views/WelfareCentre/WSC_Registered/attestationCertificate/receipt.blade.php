...
@section('title', 'Attestation Certificate')
                ...
                <div class="col-12">
                    <div class="panel panel-primary " style="border-left: 5px solid green;">
                        <div class="panel-body">
                            ...
                            <p>This page has been enhanced for printing. Click the print button at the bottom of the invoice
                                to test.</p>
                        </div>
                    </div>
                                ...
                                <div class="col-12">
                                    ...
                                    @if ($attestationCertificate->service_status == 'On Process')
                                        <button style="margin-right: 5px;" class="btn btn-success float-right"
                                            ...
                                            value="{{ route('WelfareCentre.attestationCertificate.statusUpdete', $attestationCertificate->id) }}">
                                            <i class="fa fa-credit-card-alt"></i> Submit Payment</button>
                                    @elseif ($attestationCertificate->service_status == 'Paid')
    ...
    <script>
        $(document).on('click', '.delete', function() {
            ...
            if (confirm("Are you sure you want to change status?")) {
                $.ajax({
                    url: "view_Attestation_receipt_action.php",
                    method: "POST",
                    data: {
                        id: id,
