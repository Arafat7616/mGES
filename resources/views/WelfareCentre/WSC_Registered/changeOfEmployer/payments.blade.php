...
@section('title', 'Change of employer Payment')
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Change of employer payment</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">Welfare Centre</a></li>
                            <li><a href="#"> WSC registered users
                                </a></li>
                            <li class="active">Change of employer payment</li>
                        </ol>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Change of employer payments</h3>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($changeEmployerServices as $changeEmployerService)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($changeEmployerService->service_status == 'Open')
                                                ...
                                                @elseif($changeEmployerService->service_status == "Not Completed")
                                                    <button type="button" class="btn btn-success btn-xs">Not
                                                        Completed</button>
                                                @else
                                                    <button type="button" class="btn btn-success btn-xs">{{ $changeEmployerService->service_status }}</button>
                                                @endif
                                            </td>
                                            <td>
                                                <a class="btn btn-primary btn-xs" href="{{ route('WelfareCentre.changeOfEmployer.receipt', $changeEmployerService->id) }}"><i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
