...
@section('title', 'Change of employer requests')
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Change of employer Request</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">Welfare Centre</a></li>
                            <li><a href="#"> WSC registered users
                                </a></li>
                            <li class="active">Change of employer Request</li>
                        </ol>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Change of employer Requests</h3>
                        </div>
                                    ...
                                    @foreach ($changeEmployerServices as $changeEmployerService)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <button type="button"
                                                        class="btn btn-success btn-xs">{{ $changeEmployerService->service_status }}</button>
                                                @endif
                                            </td>
                                            <td>
                                                ...
                                                <a class="btn btn-primary btn-xs"
                                                    href="{{ route('WelfareCentre.changeOfEmployer.upload', $changeEmployerService->id) }}"><i
