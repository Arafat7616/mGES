                ...
                <div class="col-sm-12">
                    <div class="page-header-title">
                        ...
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="active">Visa Rejected candidates</li>
                        </ol>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Visa Rejected candidates</h3>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($offeredCandidates as $offeredCandidate)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($offeredCandidate->result_status == 'Visa-Stamping-Rejected')
                                                    <span class="badge badge-danger">Visa-Stamping-Rejected</span>
                                            ...
                                            <td><a class="btn btn-info btn-sm" href="{{ route('MalaysiaEmbassy.visaProcess.rejectedCandidateProfile', $offeredCandidate->id) }}">
