                    ...
                    <div class="panel panel-secondary card-outline">
                        <div class="panel-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                @if ($offeredCandidate->result_status == 'Visa-Applied')
                                    <li class="list-group-item">
                                        <b>Status</b> <a class="float-right"> <button type="button"
                                                class="btn btn-primary btn-xs update">Visa-Requested</button>
                                    </li>

                                @else
                                    <li class="list-group-item">
                                        <b>Status</b> <a class="float-right"> <button type="button"
                                                class="btn btn-primary btn-xs update">{{ $offeredCandidate->result_status }}</button>
                                    </li>
                                @endif
                            </ul>
                        </div>
