<nav class="navbar navbar-expand-lg navbar-light topHeading">
    <div class="container p-2">
        <a class="navbar-brand" href="{{ route('homePage') }}">
            <img src="{{ asset('assets/landingPageAsset/img/MGES-Logo-White.png') }}" alt="" style="height: 60px" />
        </a>
        ...
        <div>
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-light" href="{{ route('conatactPage') }}">CONTACT US</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <ul class="text-center navbar-nav mx-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item mx-2 dropdown {{ request()->is('mges/*') ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li>
                            <a class="dropdown-item" href="#">Recruitment Agencies</a>
                        </li>
                        <li>
