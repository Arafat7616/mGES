...
@section('title', 'New Biometric Agency Requests')
                ...
                <div class="col-sm-12">
                    <div class="page-header-title">
                        ...
                        <ol class="breadcrumb pull-right">
                            ...
                            <li><a href="#">Biometric Agency</a></li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">New Biometric Agency Requests</h3>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('OneStopService.company.showCompanyProfile', $user->id) }}">
                                            ...
                                            <td>
                                                <button class="btn btn-danger" onclick="reject(this)"
                                                    value="{{ route('OneStopService.company.rejectNow', $user->id) }}">
