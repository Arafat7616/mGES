...
@section('title', 'Ready To Travel Candidates')
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header-title">
                    <h4 class="pull-left page-title">Ready To Travel Candidates</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="#">Excelanto</a></li>
                        <li><a href="#">Ticket Process</a></li>
                        <li class="active">Ready To Travel Candidates</li>
                    </ol>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Ready To Travel Candidated List</h3>
                    </div>
                                ...
                                @foreach ($offeredCandidates as $offeredCandidate)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-success btn-xs "><b>Ready To Travel</b> <i class="fa fa-plane" aria-hidden="true"></i> </button>
                                        ...
                                        <td>
                                            <a class="btn btn-info btn-xs"
                                                href="{{ route('OneStopService.travelEnquiry.showVisaStampingApprovedCandidate', $offeredCandidate->id) }}"><i
                                                    class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
