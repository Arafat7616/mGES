            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Security Clearance Profile</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">mGES</a></li>
                            <li><a href="#">Security Clearance
                                </a></li>
                            <li class="active">Security Clearance Profile</li>
                        </ol>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                ...
                                <br>
                                {!! QrCode::size(300)->generate(url('police-certificate/'.$candidate->id)) !!}
                            </div><!-- /.card-body -->
                        </div> <!-- /.nav-tabs-custom -->
                    </div> <!-- /.col -->
                </div>
