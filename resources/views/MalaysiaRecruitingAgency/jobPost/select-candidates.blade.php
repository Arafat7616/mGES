                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info btn-xs"
                                                    href="{{ route('MalaysiaRecruitingAgency.candidate.show', $candidate->id) }}"><i
                                                        class="fa fa-eye"></i></a>
                                                @if ($candidate->status == 'Active')
                                                    <button class="btn btn-success btn-xs" onclick="approve(this)"
                                                        value="{{ route('MalaysiaRecruitingAgency.candidate.approveNow', [$candidate->id, $appliedJob->id]) }}">
                                                ...
                                                @elseif ($candidate->status == "Selected")
                                                    <button class="btn btn-danger btn-xs" onclick="reject(this)"
                                                        value="{{ route('MalaysiaRecruitingAgency.candidate.rejectNow', $candidate->id) }}">
