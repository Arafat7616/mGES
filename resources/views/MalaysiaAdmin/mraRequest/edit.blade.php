            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Malaysia Recruiting Agency</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">mGES</a></li>
                            <li class="active">MRA Requests
                            </li>
                            <li><a href="#">Edit MRA Request</a></li>
                        </ol>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" enctype="multipart/form-data"
                                action="{{ route('MalaysiaAdmin.mraRequest.update', $user->id) }}">
                                @csrf
                                {{-- <input type="text"> --}}
                                <div class="row">
                                    <!-- Basic example -->
                                    ...
                                    <div class=" text-right">
                                        <button type="submit" class="btn btn-dark waves-effect waves-ligh">Approve</button>
                                    </div>
                                </div> <!-- End row -->
                            </form>
                        </div><!-- panel-body -->
