            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Pending Jobs</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">mGES</a></li>
                            <li><a href="#">Employer Demanded Jobs</a></li>
                                    ...
                                    @foreach ($job_posts as $job_post)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('MalaysiaAdmin.employerDemand.edit', $job_post->id) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
