...
@section('title', 'Extension - Renewal Passport Approved')
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header-title">
                    <h4 class="pull-left page-title">Extension - Renewal Passport Approved</h4>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Extension - Renewal Passport Approved</h3>
                    </div>
