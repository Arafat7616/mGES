<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="{{ route('MedicalAgency.dashboard') }}" class="logo"><img src="{{ asset('assets/images/mges.png') }}" height="28"></a>
            <a href="{{ route('MedicalAgency.dashboard') }}" class="logo-sm"><img src="{{asset('assets/images/logo_sm.png')}}" height="36"></a>
        </div>
    </div>
