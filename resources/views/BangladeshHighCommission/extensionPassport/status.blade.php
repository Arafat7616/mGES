...
@section('main-content')
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('BangladeshHighCommission.extensionPassport.statusUpdate', $extensionPassport->id )}}" method="post" enctype="multipart/form-data">
                    <div class="panel panel-primary">
                            <input type="hidden" value="{{ $extensionPassport->id }}" name="id">
                            @csrf
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control my-select-changer" name="serviceStatus" id="serviceStatus"
                                                    ...
                                                    <option {{ $extensionPassport->service_status == 'Approved' ? 'selected' : ''}}  value="Approved">Approved</option>
                                                    <option {{ $extensionPassport->service_status == 'Rejected' ? 'selected' : ''}}  value="Rejected">Rejected</option>
                                                </select>
                                            </div>
