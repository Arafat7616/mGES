                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <form role="form" method="POST" enctype="multipart/form-data"
                                    action="{{ route('BangladeshHighCommission.companyPrfileSubmit') }}">
                                    @csrf
                                    <div class="row">
                                        <!-- Basic example -->
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="companyRegisterNumber"
                                                        ...
                                                        class="form-control" id="companyRegisterNumber" value="{{ $user->company_register_number  }}">
                                                </div>
                                                <div class="form-group">
                        ...
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body">
                                <div class="text-center">
                                    ...
                                    <h1 class="profile-name">{{ $user->name }} <a class="btn btn-success" href="{{ route('BangladeshHighCommission.editProfile') }}"><i class="fa fa-edit"></i> Edit Profile </a></h1>
                                </div>
                                <div class="row">
                                    <ul class="list-group">
