            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">New Passport Request</h3>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info btn-sm"
                                                href="{{ route('BangladeshHighCommission.candidate.showCandidateProfile', $newPassport->candidate_id) }}">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a class="btn btn-info btn-sm"
                                                href="{{ route('BangladeshHighCommission.newPassport.status', $newPassport->id) }}">
