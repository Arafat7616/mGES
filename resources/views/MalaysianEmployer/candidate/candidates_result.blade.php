                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Reviewed Candidates List</h3>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($offeredCandidate->result_status == 'Updated')
                                                    <a class="btn btn-info btn-xs" href="{{ route('MalaysianEmployer.candidates.editInterview', $offeredCandidate->id) }}"><i class="fa fa-check"></i></a>
                                                @endif

                                                <a class="btn btn-info btn-xs" href="{{ route('MalaysianEmployer.candidates.showOfferedCandidate', $offeredCandidate->id) }}"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
