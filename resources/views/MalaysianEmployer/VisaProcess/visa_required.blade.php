...
@section('title', 'Visa required candidates')
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Visa required candidates</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="#">mGES</a></li>
                            <li><a href="#">Visa Process</a></li>
                            <li class="active">Visa required candidates</li>
                        </ol>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Visa required candidates List</h3>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               <a class="btn btn-info btn-xs"
                                                    href="{{ route('MalaysianEmployer.VisaProcess.showVisaRequiredCandidate', $offeredCandidate->id) }}"><i
                                                        class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
