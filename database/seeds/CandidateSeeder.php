...
class CandidateSeeder extends Seeder
{
    ...
    public function run(Faker $faker)
    {
        ...
        for ($i=0; $i <800 ; $i++) {
            ...
            $candidate = new Candidate();
            $candidate->candidate_name      = 'Monir Hossen';
            $candidate->role_id             = 15;
            $candidate->job_id              = $faker->numberBetween(1, 25);
            $candidate->company_id          = $faker->numberBetween(1, 10);
            $candidate->job_category_id     = rand(1, 13);
            ...
            $candidate->passport_number     = Str::random(18);
            $candidate->phone_number        = $faker->phoneNumber();
            $candidate->father_name        = 'Shamsher Ali';
            $candidate->mother_name        = 'Mina Begum';
            $candidate->candidate_email     = 'monir@gmail.com';
            $candidate->status              = 'Active';
            $candidate->offered_status      = $faker->randomElements([true, false])[0];
            $candidate->result_status       = 'New';
            $candidate->nationality         = 'Bangladeshi';
            $candidate->present_address     = 'Dhaka, bangladesh';
            $candidate->permanent_address   = 'Tangail, bangladesh';
            $candidate->created_id          = $faker->numberBetween(28,37);
            $candidate->permission_status   = $faker->numberBetween(1,2);
            $candidate->created_at          = Carbon::now();
            $candidate->sending_status      = $faker->numberBetween(1,2);
            ...
            $candidate = new Candidate();
            $candidate->candidate_name      = 'Mizanual Rahman Raihan';
            $candidate->role_id             = 15;
            $candidate->job_id              = $faker->numberBetween(1, 25);
            $candidate->company_id          = $faker->numberBetween(1, 10);
            $candidate->job_category_id     = rand(1, 13);
            ...
            $candidate->passport_number     = Str::random(18);
            $candidate->phone_number        = $faker->phoneNumber();
            $candidate->father_name        = 'Karim Ullah';
            $candidate->mother_name        = 'Tasnuva Begum';
            $candidate->candidate_email     = 'raihan@gmail.com';
            $candidate->status              = 'Active';
            $candidate->offered_status      = $faker->randomElements([true, false])[0];
            $candidate->result_status       = 'New';
            $candidate->nationality         = 'Bangladeshi';
            $candidate->present_address     = 'Dhaka, Bangladesh';
            $candidate->permanent_address   = 'Satkhira, Bangladesh';
            $candidate->created_id          = $faker->numberBetween(28,37);
            $candidate->permission_status   = $faker->numberBetween(1,2);
            $candidate->created_at          = Carbon::now();
            $candidate->sending_status      = $faker->numberBetween(1,2);
            ...
            $candidate = new Candidate();
            $candidate->candidate_name      = 'Apurbo Kumar Anup';
            $candidate->role_id             = 15;
            $candidate->job_id              = $faker->numberBetween(1, 25);
            $candidate->company_id          = $faker->numberBetween(1, 10);
            $candidate->job_category_id     = rand(1, 13);
            ...
            $candidate->passport_number     = Str::random(18);
            $candidate->phone_number        = $faker->phoneNumber();
            $candidate->father_name         = 'Sonil Kumar';
            $candidate->mother_name         = 'Nibha Rani';
            $candidate->candidate_email     = 'apurbo@gmail.com';
            $candidate->status              = 'Active';
            $candidate->offered_status      = $faker->randomElements([true, false])[0];
            $candidate->result_status       = 'New';
            $candidate->nationality         = 'Bangladeshi';
            $candidate->present_address     = 'Dhaka, Bangladesh';
            $candidate->permanent_address   = 'Joypurhat, Bangladesh';
            $candidate->created_id          = $faker->numberBetween(28,37);
            $candidate->permission_status   = $faker->numberBetween(1,2);
            $candidate->created_at          = Carbon::now();
            $candidate->sending_status      = $faker->numberBetween(1,2);
            ...
            $candidate = new Candidate();
            $candidate->candidate_name      = 'Arafat Hossin';
            $candidate->role_id             = 15;
            $candidate->job_id              = $faker->numberBetween(1, 25);
            $candidate->company_id          = $faker->numberBetween(1, 10);
            $candidate->job_category_id     = rand(1, 13);
            ...
            $candidate->passport_number     = Str::random(18);
            $candidate->phone_number        = $faker->phoneNumber();
            $candidate->father_name         = 'Md. Mahsin';
            $candidate->mother_name         = 'Bibi Hazra Begum';
            $candidate->candidate_email     = 'arafat@gmail.com';
            $candidate->status              = 'Active';
            $candidate->offered_status      = $faker->randomElements([true, false])[0];
            $candidate->result_status       = 'New';
            $candidate->nationality         = 'Bangladeshi';
            $candidate->present_address     = 'Dhaka, Bangladesh';
            $candidate->permanent_address   = 'Noakhali, Bangladesh';
            $candidate->created_id          = $faker->numberBetween(28,37);
            $candidate->permission_status   = $faker->numberBetween(1,2);
            $candidate->created_at          = Carbon::now();
            $candidate->sending_status      = $faker->numberBetween(1,2);
            ...
            $candidate = new Candidate();
            $candidate->candidate_name      = 'Imdadul Haque';
            $candidate->role_id             = 15;
            $candidate->job_id              = $faker->numberBetween(1, 25);
            $candidate->company_id          = $faker->numberBetween(1, 10);
            $candidate->job_category_id     = rand(1, 13);
            ...
            $candidate->passport_number     = Str::random(18);
            $candidate->phone_number        = $faker->phoneNumber();
            $candidate->father_name         = 'Ismail Hossain';
            $candidate->mother_name         = 'Marzia Khatun';
            $candidate->candidate_email     = 'imdadul@gmail.com';
            $candidate->status              = 'Active';
            $candidate->offered_status      = $faker->randomElements([true, false])[0];
            $candidate->result_status       = 'New';
            $candidate->nationality         = 'Bangladeshi';
            $candidate->present_address     = 'Dhaka, Bangladesh';
            $candidate->permanent_address   = 'Sirajganj, Bangladesh';
            $candidate->created_id          = $faker->numberBetween(28,37);
            $candidate->permission_status   = $faker->numberBetween(1,2);
            $candidate->created_at          = Carbon::now();
            $candidate->sending_status      = $faker->numberBetween(1,2);
